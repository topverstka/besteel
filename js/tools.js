...
$(document).ready(function() {
    ...
    $(".about-partners").each(function() {
        ...
        curSlider.slick({
            ...
            slidesToScroll: 1,
            adaptiveHeight: true,
            prevArrow: '<button type="button" class="slick-prev"><svg><use xlink:href="' +
                pathTemplate +
                'images/sprite.svg#slider-prev"></use></svg></button>',
            nextArrow: '<button type="button" class="slick-next"><svg><use xlink:href="' +
                pathTemplate +
        ...
        if ($(window).width() > 992) {
            $(".page-main").mousewheel(function(event) {
                if (!isAnimateScroll) {
                    ...
                    if (offAnim) {
                        $("html, body").animate({ scrollTop: mainScroll },
                            time,
                            "easeInOutQuad",
                            function() {
